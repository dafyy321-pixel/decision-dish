...
| **P1** | 扩展功能（2项：历史记录、数据导入导出） | ⏸️ 未开始 | **0%** |
...
| --- | --- | --- | --- | --- |
| v1.1 | 2025-11-03 ~ 2025-11-16 | 可记录与迁移数据 | 历史记录、数据导入导出 | 最近10条历史；JSON 导入导出（校验、去重、≤20项）；异常有 Toast；核心用例自测通过 |
